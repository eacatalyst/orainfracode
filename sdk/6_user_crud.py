...
print("Creating a new user {!r} in compartment {!r}".format(user_name, compartment_id))
...
print("Creating a new group {!r} in compartment {!r}".format(group_name, compartment_id))
